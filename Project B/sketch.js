...
function setup() {
  ...
  objects.push(obj1);
  let obj2 = new EmotionObj(width * 0.48, height * 0.48, 0.2, emotion2, sound2);
  objects.push(obj2);
  let obj3 = new EmotionObj(width * 0.5, height * 0.48, 0.2, emotion3, sound3);
  objects.push(obj3);
  let obj4 = new EmotionObj(width * 0.57, height * 0.48, 0.07, emotion4, sound4);
  objects.push(obj4);
  let obj5 = new EmotionObj(width * 0.42, height * 0.57, 0.2, emotion5, sound5);
  objects.push(obj5);
  let obj6 = new EmotionObj(width * 0.48, height * 0.57, 0.2, emotion6, sound6);
  objects.push(obj6);
  let obj7 = new EmotionObj(width * 0.5, height * 0.57, 0.1, emotion7, sound7);
  objects.push(obj7);
  let obj8 = new EmotionObj(width * 0.48, height * 0.57, 0.15, emotion8, sound8);
  objects.push(obj8);
